...
export const TEACHERS: Teacher[] = [
  {
    ...
    bio: "مدرس رشتهٔ بازیگری در کارگاه فیلم‌نما، با سال‌ها تجربهٔ کار عملی مقابل دوربین و روی صحنهٔ تئاتر. تمرکز او بر آموزش تکنیک‌های شخصیت‌پردازی، کار با دیالوگ و بدنِ بازیگر است؛ از گرم‌کردن و تمرین‌های پایه تا اجرای کامل یک سکانس مقابل دوربین. هنرجویانش نه‌تنها تئوری بازیگری را یاد می‌گیرند، بلکه قاب به قاب با او کار می‌کنند تا لحظهٔ واقعی بازی در کادر ثبت شود. روش تدریس او ترکیبی از تجربهٔ میدانی و تمرین‌های عملی است که هنرجو را برای ورود به یک پروژهٔ واقعی سینمایی آماده می‌کند.",
    initials: "ر.ر",
  ...
  },
  {
    ...
    bio: "از مدرسان آموزشگاه آزاد سینمایی فیلم‌نما که در کنار تیم آموزشی این کارگاه، هنرجویان را در مسیر شناخت سینما و هنرهای نمایشی همراهی می‌کند. او با نگاهی دقیق و منتقدانه، به هنرجویان کمک می‌کند تا زبان تصویر، درک دراماتیک و حس کارگردانی را از نزدیک تجربه کنند. حضور او در تیم فیلم‌نما، پلی میان تئوری آکادمیک و کار عملیِ کارگاه است؛ جایی که هر هنرجو یاد می‌گیرد چطور ایدهٔ ذهنی‌اش را به یک قاب واقعی تبدیل کند.",
    initials: "ح.ت",
  ...
  },
  {
    ...
    bio: "بازیگر باسابقهٔ سینما و تلویزیون ایران و از مدرسان فیلم‌نما. از مهم‌ترین سوابق هنری او ایفای نقش در سریال پرمخاطب «یوسف پیامبر» به کارگردانی فرج‌الله سلحشور، و حضور در فیلم «دوزخ برزخ بهشت» و چند اثر تلویزیونی دیگر است. تجربهٔ حضور در پروژه‌های بزرگ تولید، او را به منبعی بی‌جایگز برای هنرجویانی تبدیل کرده که می‌خواهند واقعیتِ کارِ بازیگری در یک پروژهٔ حرفه‌ای را از نزدیک بشناسند. او در کارگاه فیلم‌نما، تجربهٔ سال‌ها حضور جلوی دوربین را به هنرجویان انتقال می‌دهد؛ از آمادگیِ صحنه و ارتباط با کارگردان تا مدیریت لحظه‌های حساسِ بازی.",
    initials: "ر.ن",
